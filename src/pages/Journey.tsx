...
const Journey = () => {
  return (
    <section>
      ...
      <button className="hidden md:block mx-auto mt-[60px] bg-gray-600 text-white text-3xl font-bold px-6 py-2 rounded-md shadow-lg hover:shadow-xl transition duration-300">
        Get your Diet plan now
      </button>
